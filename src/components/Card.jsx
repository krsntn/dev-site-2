  ...
  return (
    <div className="relative m-6 h-72 w-64 bg-gray-200 dark:bg-gray-800 rounded-lg text-sm transform duration-200 hover:-translate-y-2">
      <div
        ...
        style={{ height: 20 }}
      >
        <div className="rounded-full bg-red-700 h-2 w-2 ml-3 mr-1"></div>
        <div className="rounded-full bg-yellow-500 h-2 w-2 mr-1"></div>
        <div className="rounded-full bg-green-600 h-2 w-2 mr-1"></div>
      </div>
      <div
